...
export default function Hero() {
  ...
  const mainSolution = {
    ...
    description: "Harness the power of AI to transform complex data into clear, actionable insights that drive business growth.",
    icon: (
      <svg
  ...
  return (
    <section className="py-24 md:py-32">
      <div className="container mx-auto px-4">
        ...
        >
          <div className="py-8 md:py-12">
            <h1 className="text-4xl md:text-5xl tracking-tight mb-8 orbit-heading">
              Let's transform static workflows into dynamic orbits with <span className="ai-glow">AI</span>
            </h1>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto mt-8">
              0rbiAccel leverages AI to transform repetitive workflows into efficient, automated cycles. By identifying patterns in complex datasets and delivering precise recommendations, it accelerates decision-making processes, reduces human effort, and allows teams to focus on higher-value tasks.
            </p>
            <div className="mt-12 flex flex-wrap justify-center gap-4">
              <Button asChild className="orbit-button rounded-full">
        ...
        <div 
          ref={mainSolutionRef}
          className={`max-w-5xl mx-auto mb-32 transition-all duration-1000 transform ${
            mainSolutionVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-20'
          }`}
        >
          <div 
            className="orbit-card p-6 md:p-8 hover:scale-[1.02] transition-transform duration-300"
            ...
            <div className="flex flex-col md:flex-row items-center md:items-start gap-6">
              ...
              <div className="flex-1 text-center md:text-left">
                <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-2">
                  <h3 className="text-2xl orbit-subheading">{mainSolution.title}</h3>
                </div>
                <p className="text-muted-foreground mb-4">{mainSolution.description}</p>
                ...
                <div className="mt-6 flex items-center justify-center md:justify-start gap-3 bg-primary/5 p-3 rounded-lg">
                  <svg 
                    xmlns="http://www.w3.org/2000/svg" 
                  ...
                  <div>
                    <span className="text-sm font-medium text-white">Available as Chrome Extension</span>
                    <p className="text-xs text-muted-foreground">Access 0rbiΔccel's AI capabilities directly in your browser as you surf</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div 
          ref={whyChooseRef}
          className={`max-w-5xl mx-auto mt-32 mb-24 transition-all duration-500 ease-out transform ${
            whyChooseVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
          }`}
        >
          <h2 className="text-2xl md:text-3xl mb-12 text-center orbit-heading">
            Why Choose <span className="orbit-font brand-glow text-lg">0rbiΔccel</span>?
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className={`orbit-card p-6 transition-all duration-300 ease-out hover:-translate-y-2 hover:shadow-lg hover:shadow-primary/5 hover:transition-all hover:duration-150 transform ${
              whyChooseVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
            }`} style={{ transitionDelay: '100ms' }}>
              <div className="flex flex-col items-center text-center">
                <div className={`bg-primary/10 p-4 rounded-full mb-4 transition-all duration-300 ease-out transform ${
                ...
                <h3 className="text-xl mb-2 orbit-subheading">Smart Insights</h3>
                <p className="text-sm text-muted-foreground">
                  Instantly transform raw data into actionable intelligence with AI that thinks like an analyst
                </p>
              </div>
            </div>
            <div className={`orbit-card p-6 transition-all duration-300 ease-out hover:-translate-y-2 hover:shadow-lg hover:shadow-primary/5 hover:transition-all hover:duration-150 transform ${
              ...
              <div className="flex flex-col items-center text-center">
                ...
                <h3 className="text-xl mb-2 orbit-subheading">Self-Improving</h3>
                <p className="text-sm text-muted-foreground">
            ...
            <div className={`orbit-card p-6 transition-all duration-300 ease-out hover:-translate-y-2 hover:shadow-lg hover:shadow-primary/5 hover:transition-all hover:duration-150 transform ${
              ...
              <div className="flex flex-col items-center text-center">
                ...
                <h3 className="text-xl mb-2 orbit-subheading">Time Reclaimed</h3>
                <p className="text-sm text-muted-foreground">
                  Recover hours of productivity by automating routine tasks while maintaining perfect accuracy
                </p>
              </div>
            </div>
          </div>
